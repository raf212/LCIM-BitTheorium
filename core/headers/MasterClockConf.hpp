...
struct Timer48
{
    ...
    public:
        ...
        inline packed64_t ComposeValue32WithMasterStamp(val32_t value32, size_t master_slot_id, tag8_t rel_mask4 = REL_MASK4_NONE)
        {
            ...
            strl16_t strl = MakeSTRL4_t(DEFAULT_INTERNAL_PRIORITY, ST_PUBLISHED, rel_mask4, static_cast<tag8_t>(RelOffsetMode::RELOFFSET_GENERIC_VALUE), static_cast<tag8_t>(PackedMode::MODE_VALUE32));
